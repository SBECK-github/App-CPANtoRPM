...
Package::CPANtoRPM - a library used by the cpantorpm tool

=head1 SYNOPSIS

This module contains routines used for the cpantorpm too.  It is not
intended to be used directly.

=head1 DESCRIPTION

The cpantorpm tool is a tool to take a package from CPAN and turn it
