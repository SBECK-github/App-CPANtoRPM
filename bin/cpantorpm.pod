...
the feature perl=5.24.1 but the module requires perl=5.024001, rpmbuild
may not work because it doesn't know how to compare these two version
numbers to know whether the requirement is met.
